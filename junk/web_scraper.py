...
class StackOverflowScraper:
    ...
    def fetch_questions(self, tag="pytorch", page=1, pagesize=100, sort="votes"):
        """Fetch questions with the specified tag."""
    ...
    def process_data(self, num_pages=5, questions_per_page=100):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Scrape PyTorch questions and answers from Stack Overflow")
    parser.add_argument("--pages", type=int, default=5, help="Number of pages to scrape")
    parser.add_argument("--questions", type=int, default=100, help="Number of questions per page")
    ...
    print(f"Starting to scrape PyTorch questions and answers from Stack Overflow...")
    
    try:
        qa_data = scraper.process_data(num_pages=args.pages, questions_per_page=args.questions)
